...
// Retirado de um Projeto que estou Realizando, Mas Relaxa que vou comentar alguns metodos
public class Looger {
    private static Looger instance;
    // sao duas datas que serviram tanto para mostrar o momento exato do logger quanto para nomear o arquivo
    private static final DateTimeFormatter dtf = DateTimeFormatter.ofPattern("yyyy-MM-dd HH:mm:ss");
    private static final DateTimeFormatter fileDtf = DateTimeFormatter.ofPattern("yyyy-MM-dd");

    // Nivel de log e o diretorio
    ...
    //Confere se o nivel da mensagem
